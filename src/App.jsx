...
const CATEGORIES = [
  ...
  { id: 'rpg', name: 'RPG', endpoint: '&genres=rpg' },
  { id: 'indie', name: 'Indé', endpoint: '&genres=indie' },
  { id: 'strategy', name: 'Stratégie', endpoint: '&genres=strategy' },
  { id: 'adventure', name: 'Aventure', endpoint: '&genres=adventure' },
  { id: 'puzzle', name: 'Puzzle', endpoint: '&genres=puzzle' },
  { id: 'shooter', name: 'FPS', endpoint: '&genres=shooter' },
  { id: 'racing', name: 'Course', endpoint: '&genres=racing' }
];
